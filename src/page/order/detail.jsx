...
class OrderDetail extends React.Component
{
    ...
    //加载商品详情
    loadOrderDetail() {   //有id的时候，表示显示编辑功能，需要表单回填
            ...
            <div id="page-wrapper">
                ...
                <div className="form-horizontal">
                            ...
                            <p className="form-control-static">
                                {this.state.orderInfo.statusDesc}
                                {
                                    this.state.orderInfo.status===20?
                                        <button className="btn btn-default btn-sm btn-send-gooods"
                    ...
                    <div className="form-group">
                        ...
                        <div className="col-md-5">
                            <p className="form-control-static">
                                {this.state.orderInfo.paymentTypeDesc}</p>
                        </div>
                    </div>
                    <div className="form-group">
                                        ...
                                        return (
                                            <tr key={index}>
                                                <td>
                                                   ...
                                                   src={`${this.state.orderInfo.imageHost}${product.productImage}`}/></td>
                                                <td>
                                                    {product.productName}
                                                </td>
